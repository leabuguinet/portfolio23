            ...
            <div className="curriculum-content">
              ...
              <section className="exp-pro">
                ...
                <div className="exp-pro-item">
                  ...
                  <div className="exp-pro-description">
                    ...
                    <p>
                      ...
                      charges et maquettes Figma (sites vitrines et e-commerce)
                    </p>
                    <p>
                    ...
                    <p>
                      Participation au rendez-vous clients pour les guider et
                      les conseiller
                    </p>
                  </div>
                </div>
                ...
                <div className="exp-pro-item">
                  ...
                  <div className="exp-pro-description">
                    <p>Freelance pour entreprises, associations et particuliers</p>
                    <p>Découvrez quelques-uns de ces projets dans le portfolio</p>
                  </div>
                </div>
              ...
              <section className="skills">
                ...
                <div className="skills-item-top">
                    ...
                    <div className="skills-logolist">
                      ...
                      <div>
                      <p><JsLogo />Javascript</p>
                        <p><GatsbyLogo /> Gatsby</p>
                        <p><ReactLogo /> React</p>
        
                      </div>

                      <div>
                        <p><WordpressLogo />Wordpress</p>
                        <p><PhpLogo />Php</p>
                        <p><SymphonyLogo /> Symphony</p>
                        <p><MysqlLogo /> MySQL</p>
                      </div>
              ...
              <section className="diplomas">
                ...
                <div className="diploma-item">
                  ...
                  <p>
                    ...
                    de données. Bonnes pratiques du développement web : sécurité, optimisation, référencement naturel et versioning.
                  </p>
                </div>
                ...
                <h3 className="diploma-item">
                  Licence Lettre Langue Civilisation Étrangère - Anglais • 2016
